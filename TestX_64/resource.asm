...
;MessageBox                  DQ RVA szMessageBox
;EndUser32                   DQ NULL
;------------------------------------------------
...
;GetEnvironmentStrings       DQ RVA szGetEnvironmentStrings
;FreeEnvironmentStrings      DQ RVA szFreeEnvironmentStrings
;InitializeCriticalSection   DQ RVA szInitializeCriticalSection
;EnterCriticalSection        DQ RVA szEnterCriticalSection
;LeaveCriticalSection        DQ RVA szLeaveCriticalSection
;DeleteCriticalSection       DQ RVA szDeleteCriticalSection
...
;GetStdHandle                DQ RVA szGetStdHandle
...
WaitForSingleObject          DQ RVA szWaitForSingleObject
...
;PeekNamedPipe               DQ RVA szPeekNamedPipe
FindFirstFile                DQ RVA szFindFirstFile
FindNextFile                 DQ RVA szFindNextFile
FindClose                    DQ RVA szFindClose
CreateFile                   DQ RVA szCreateFile
;GetFileAttributes           DQ RVA szGetFileAttributes
GetFileType                  DQ RVA szGetFileType
GetFileSizeEx                DQ RVA szGetFileSizeEx
SetFilePointer               DQ RVA szSetFilePointer
ReadFile                     DQ RVA szReadFile
WriteFile                    DQ RVA szWriteFile
;MoveFile                    DQ RVA szMoveFile
DeleteFile                   DQ RVA szDeleteFile
;GetCurrentDirectory         DQ RVA szGetCurrentDirectory
;SetCurrentDirectory         DQ RVA szSetCurrentDirectory
CreateDirectory              DQ RVA szCreateDirectory
RemoveDirectory              DQ RVA szRemoveDirectory
...
;htons                       DQ RVA szHtons
;inet_ntoa                   DQ RVA szInet_ntoa
;inet_addr                   DQ RVA szInet_addr
...
szHeaderServer                DB 13,10, 'Server: WebTestXServer 1.1.75 x64'
...
lppReportMessages DQ REPORT_MESSAGE_COUNT dup(?)
;------------------------------------------------
;       * * *  Init Table Buffer
;------------------------------------------------
...
LocalYear            DWORD ?
DateRandom           DWORD ?
ReadBytes            QWORD ?   ;   GetFileSizeEx()
WriteBytes           QWORD ?
WriteIndex           QWORD ?
FileSize             QWORD ?
BaseSize             QWORD ?   ;   AddTable()
